...
final class FormContentBuilderImpl: ObservableObject, FormContentBuilder {
    ...
    private(set) var content: [FormComponent] = [
        TextFormComponent(id: .firstName,
                          ...
                          validations: [RegexValidationManagerImpl(
        ...
        TextFormComponent(id: .email,
                          ...
                          validations: [RegexValidationManagerImpl(
                            [RegexFormItem(pattern: RegexPatterns.emailChars, error: .custom(message: "Invalid Email - No @ sign")),
                             RegexFormItem(pattern: RegexPatterns.higherThanSixChars, error: .custom(message: "Less than 6 characters entered"))]
                                    )]),
